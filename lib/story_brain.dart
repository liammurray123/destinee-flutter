...
//TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory(int choiceNumber) {
    //TODO: Step 21 - Using the story plan, update nextStory to change the _storyNumber depending on the choice made by the user.
...
//TODO: Step 25 - Create a method called buttonShouldBeVisible() which checks to see if _storyNumber is 3 or 4 or 5 (the end of the game) and return true if that is the case, else it should return false.
